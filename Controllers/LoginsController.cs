...
namespace AppMVC.Controllers
{
    public class LoginsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Link,Usuario,Contraseña")] Login login)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Link,Usuario,Contraseña")] Login login)
        {
            if (id != login.Id)
            {
                return NotFound();
